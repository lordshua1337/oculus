...
export default function ScenarioLabError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[Scenario Lab Error]', error.message, error.digest)
  }, [error])
  ...
  return (
    ...
    >
      ...
      >
        {error.message || 'Failed to load Scenario Lab. Please try again.'}
      </p>
