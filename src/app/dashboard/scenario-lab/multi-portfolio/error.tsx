...
export default function MultiPortfolioError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[Multi-Portfolio Error]', error.message, error.digest)
  }, [error])
  ...
  return (
    ...
    >
      ...
      >
        {error.message || 'Failed to load portfolio comparison. Please try again.'}
      </p>
