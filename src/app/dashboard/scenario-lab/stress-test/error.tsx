...
export default function StressTestError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[Stress Test Error]', error.message, error.digest)
  }, [error])
  ...
  return (
    ...
    >
      ...
      >
        {error.message || 'Failed to run stress test. Please try again.'}
      </p>
